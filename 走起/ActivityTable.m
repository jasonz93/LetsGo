...
-(void)QuitActivity{
    ...
    NSString *URLpre=[Common getUrlString:[NSString stringWithFormat:@"/activity_memberships/%ld.json?user_token=%@",(long)ship_id,Mytoken]];
...
-(void)JionSuccess
{
    ...
    NSLog(@"%@",test);
    NSLog(@"Get New ship id:%ld",(long)ship_id);
    cell.textLabel.text = @"离开";
}
