...
-(IBAction)Commit:(id)sender{
    ...
    [dic setValue:@"" forKey:@"activity_latitude"];
    [dic setValue:@"" forKey:@"activity_longtitude"];
    [dic setValue:self.txtActTime.text forKey:@"activity_time"];
    [dic setValue:self.txtActDur.text forKey:@"activity_duration"];
